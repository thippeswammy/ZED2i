...
#     camera_resolution=sl.RESOLUTION.VGA,  # Lower resolution for higher FPS
#     depth_mode=sl.DEPTH_MODE.PERFORMANCE,  # Faster depth processing
#     coordinate_units=sl.UNIT.METER,
#     camera_fps=22  # Fixed FPS for stability
# )
init_params = sl.InitParameters(
