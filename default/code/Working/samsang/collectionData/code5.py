...
downsample = 10
plt.figure(figsize=(10, 6))
plt.plot(imu_data['position_x'], imu_data['position_y'], '-', label='Fused Path')
plt.quiver(
...
ax.plot(imu_data['position_x'], imu_data['position_y'], imu_data['position_z'], '-o', label='Fused Path')
